...
In this plot, we observed a clear increase in volatility during the index. Before 
2020, the log returns are represented with grey vertical bars and has a relatively 
low range. After the pandemic hit the market
